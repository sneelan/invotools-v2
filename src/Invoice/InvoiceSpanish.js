        ...
        <section className="border-4 border-top border-theme-accent" id="order-info">
            <div className="row m-0 py-2 p-lg-2 text-center text-sm-start border-2 border-white border-bottom order-info-row1">
                ...
                <div className="col-sm-4">
                    <h4 className="text-uppercase d-inline-block ">NÚMERO DE ORDEN : </h4>
            ...
            <div className="row m-0 p-sm-2 p-lg-3 text-center text-sm-start order-info-row2 ">
                ...
                <div className="col-sm-4 mb-4 mb-sm-0">
                    ...
                    <p>
                        ...
                        <b>Teléfono  :</b> 0987329382<br/>
                        <b>Correo electrónico :</b> olivia@gmail.com<br/>
                        <b>GST del cliente :</b> #######123###
                    </p>
                ...
                <div className="col-sm-4 mb-4 mb-sm-0">
                    ...
                    <p>Thomas Wilson<br/>
                        123 Anywhere St<br/>
                        Cualquier ciudad, ST 12345<br/>
                        <b>Teléfono  :</b> 09327329382<br/>
                        <b>Correo electrónico :</b> thomas@gmail.com<br/></p>
        ...
        <main className="px-2">
                ...
                <table className="w-100">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="text-start"><a className="hover-underline" href="https://www.ayatacommerce.com/" target="_blank">Camisas De Moda Slim Fit Manga Larga Azul Marino</a></td>
                            <td>PRSKNU0A1</td>
                            <td>1149</td>
                            <td>1</td>
                            <td>10%</td>
                        ...
                        <tr>
                            ...
                            <td className="text-start"><a className="hover-underline" href="https://www.ayatacommerce.com/" target="_blank">Camisetas de cuello redondo para mujer Fashion Relax Fit</a></td>
                            <td>PRSKNU0A2</td>
                            <td>594</td>
                            <td>2</td>
                            <td>10%</td>
                        ...
                        <tr>
                            ...
                            <td className="text-start"><a className="hover-underline" href="https://www.ayatacommerce.com/" target="_blank">Moda Regular Fit Cuello Polo Camisetas Cortas Slv Óxido</a>
                            </td>
                            <td>PRSKNU0A3</td>
                            <td>749</td>
                            <td>3</td>
            ...
            <div className="mob-products">                
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.ayatacommerce.com/" target="_blank"> Camisas De Moda Slim Fit Manga Larga Azul Marino</a></div>
                ...
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.ayatacommerce.com/" target="_blank">Camisetas de cuello redondo para mujer Fashion Relax Fit</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
                ...
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.ayatacommerce.com/" target="_blank">Moda Regular Fit Cuello Polo Camisetas Cortas Slv Óxido</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
                ...
                <div className="align-self-stretch pt-lg-2 pe-lg-3">
                    <div className="d-flex flex-column-reverse flex-sm-column w-100 h-100 text-start text-sm-start my-notes">
                        <div className="align-self-stretch flex-grow-1">
                            <p><b>Nota de pedido : </b> En Ayatacommerce, nuestro objetivo es lograr entregas perfectas en todo momento. En caso de devolución, asegúrese de tener la caja, la etiqueta de precio, el embalaje y la factura originales de la marca, ya que son esenciales para procesar su solicitud. Su cooperación es muy apreciada.                        </p>
                        </div>
                        <div className="w-100 pb-lg-0 pe-1 pb-sm-0 pt-2 pt-sm-0">
                            <p><strong> Cantidad en palabras:</strong> tres mil ochocientos sesenta y un rupias</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="sec-sign">
            <div className="d-sm-flex align-items-center justify-content-between px-2 py-lg-2 mt-1 mt-sm-0">
                ...
                <div className="text-center text-sm-end py-sm-3 sec-sign-right">
                    <h4>AyataCommerce Pvt. Limitado</h4>
                    <span id="sign" ></span>
                    <p><small>Firmante autorizado</small></p>
                </div>
            </div>
        </section>
        <footer>
            ...
            <div className="col-sm-7 col-lg-9 align-self-stretch footer-right pb-lg-1">
                <div className="d-flex align-items-center justify-content-center justify-content-sm-between px-3">
                    <p>Gracias</p>
                    <h4 className="opacity-75 text-center w-100 d-none d-sm-block">Síganos</h4>
                </div>
