        ...
        <header className="px-2 px-lg-2 hover">
            <div className="xd-sm-flex xalign-items-center xjustify-content-between row m-0 p-0">
                <div id="header-left" className="text-center col-sm-6 col-md-4 col-lg-4 d-flex align-items-center justify-content-center p-0 ps-md-3">
                    <a className="logo m-auto " href="https://ayatacommerce.com" target="_blank">AyataCommerce</a></div>
                <div className="xalign-self-stretch d-none d-md-block d-md-flex align-items-end justify-content-center col-md-4 ">
                    <div className="bg-theme-accent text-theme-secondary text-center p-2 p-md-3 pt-md-4 pb-md-3 px-md-5 title">
                        <span className="fs-3 fw-bold text-uppercase">चालान</span>
                        <span className="clear d-block p small ">(प्राप्तकर्ता के लिए मूल)</span>
                    </div>
                </div>
                <div id="header-right" className="p-1 pe-lg-2 py-lg-2 col-sm-6 col-md-4 col-lg-4 d-md-flex align-items-center justify-content-end">
                    <div>
                        <h4 className="text-center text-sm-end pt-1 pt-sm-0">अयाताकॉमर्स प्रा. लिमिटेड</h4>                    
                        <p className="text-center text-sm-end pb-1 pb-sm-0">लंदन, यूके, ज़िप: nE61PWt <br/>
                            लंदन, यूके, ज़िप: nE61PWt<br/>
        ...
        <section className="border-4 border-top border-theme-accent" id="order-info">
            <div className="row m-0 py-2 p-lg-2 text-center text-sm-start border-2 border-white border-bottom order-info-row1">
                <div className="col-sm-4 ps-lg-4 ">
                    <span className="d-block "><h4 className="text-uppercase d-inline-block ">चालान नंबर : </h4>
                    <p className="d-inline-block ps-2 ps-sm-1">#852352</p>
                    </span>
                    <h4 className="clear text-uppercase d-inline-block ">तारीख  : </h4>
                    <p className="d-inline-block ps-2 ps-sm-1">शुक्रवार 9 अगस्त 2023</p>
                </div>
                ...
                <span class="d-block "><h4 className="text-uppercase d-inline-block ">क्रम संख्या  : </h4>
            ...
            <div className="row m-0 p-sm-2 p-lg-3 text-center text-sm-start order-info-row2 ">
                ...
                <div className="col-sm-4 mb-4 mb-sm-0">
                    <h4>शिपिंग की जानकारियां</h4>
                    <p>
                        ओलिविया विल्सन <br/>
                        123 कहीं भी सेंट<br/>
                        कोई भी शहर, एसटी 12345<br/>
                        <b>फोन  :</b> 0987329382<br/>
                        <b>ईमेल :</b> olivia@gmail.com<br/>
                        <b>ग्राहक जीएसटी GST :</b> #######123###
                    </p>
                ...
                <div className="col-sm-4 mb-4 mb-sm-0">
                    <h4>बिलिंग विवरण</h4>
                    <p>थॉमस विल्सन<br/>
                        123 एनीव्हेयर सेंट<br/>
                        एनी सिटी, एसटी 12345<br/>
                        <b>फोन  :</b> 09327329382<br/>
                        <b>ईमेल :</b> thomas@gmail.com<br/></p>
        ...
        <main className="px-2">
            <div className="product">
                <table className="w-100">
                    <tbody>
                        <tr className="w-100">
                            <th>उत्पाद</th>
                            <th className="productनाम">नाम</th>
                            <th>एसकेयू</th>
                            <th>यूनिट मूल्य	</th>
                            <th>मात्रा</th>
                            <th>कर</th>
                        ...
                        <tr>
                            ...
                            <td className="text-start"><a className="hover-underline" href="https://www.ayatacommerce.com/" target="_blank"> 	फैशन स्लिम फ़िट शर्ट्स लंबी आस्तीन वाली नेवी</a></td>
                            <td>PRSKNU0A1</td>
                            <td>1149</td>
                            <td>1</td>
                            <td>10%</td>
                        ...
                        <tr>
                            ...
                            <td className="text-start"><a className="hover-underline" href="https://www.ayatacommerce.com/" target="_blank">	फैशन रेगुलर फिट पोलो नेक शॉर्ट एसएलवी टी-शर्ट्स रस्ट</a></td>
                            <td>PRSKNU0A2</td>
                            <td>594</td>
                            <td>2</td>
                            <td>10%</td>
                        ...
                        <tr>
                            ...
                            <td className="text-start"><a className="hover-underline" href="https://www.ayatacommerce.com/" target="_blank">	फैशन रिलैक्स फ़िट महिला क्रू नेक टी-शर्ट</a>
                            </td>
                            <td>PRSKNU0A3</td>
                            <td>749</td>
                            <td>3</td>
            ...
            <div className="mob-products">                
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.ayatacommerce.com/" target="_blank"> 	फैशन स्लिम फ़िट शर्ट्स लंबी आस्तीन वाली नेवी</a></div>
                ...
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.ayatacommerce.com/" target="_blank"> 	फैशन रेगुलर फिट पोलो नेक शॉर्ट एसएलवी टी-शर्ट्स रस्ट</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
                ...
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.ayatacommerce.com/" target="_blank">		फैशन रिलैक्स फ़िट महिला क्रू नेक टी-शर्ट</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
            ...
            <div className="d-sm-flex flex-sm-row-reverse align-items-start justify-content-between" id="sec-notes">                    
                ...
                <div className="align-self-stretch pt-lg-2 pe-lg-3">
                    <div className="d-flex flex-column-reverse flex-sm-column w-100 h-100 text-start text-sm-start my-notes">
                        <div className="align-self-stretch flex-grow-1">
                            <p><b>ऑर्डर नोट : </b> अयाटाकॉमर्स में, हम हर बार सही डिलीवरी का लक्ष्य रखते हैं। वापसी के मामले में, कृपया सुनिश्चित करें कि आपके पास मूल ब्रांड बॉक्स, मूल्य टैग, पैकिंग और चालान है, क्योंकि ये आपके अनुरोध को संसाधित करने के लिए आवश्यक हैं। आपका सहयोग बहुत सराहनीय है।</p>
                        </div>
                        <div className="w-100 pb-lg-0 pe-1 pb-sm-0 pt-2 pt-sm-0">
                            <p><strong> रकम शब्दों में:</strong> तीन हजार आठ सौ इकसठ रुपये</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="sec-sign">
            <div className="d-sm-flex align-items-center justify-content-between px-2 py-lg-2 mt-1 mt-sm-0">
                <div className="py-2 py-lg-2 sec-sign-left">
                    <div className="">
                        ...
                        <p className=""> Credit Card 
                            क्रेडिट कार्ड लेनदेन आईडी: <b>310b174b17ba3</b><br/>
                            भुगतान स्थिति: <b>Success</b><br/>
                            भुगतान दिनांक: <b>13-03-2025</b><br/>
                            भुगतान राशि: <b>₹ 505.50 </b></p>
                        </div>
                    </div>
                ...
                <div className="text-center text-sm-end py-sm-3 sec-sign-right">
                    <h4>अयाताकॉमर्स प्रा. लिमिटेड</h4>
                    <span id="sign"></span>
                    <p><small>अधिकृत हस्ताक्षरकर्ता</small></p>
                </div>
            </div>
        </section>
        <footer>
            ...
            <div className="col-sm-7 col-lg-9 align-self-stretch footer-right pb-lg-1">
                <div className="d-flex align-items-center justify-content-center justify-content-sm-between px-3">
                    <img src="/invoice-css/assets/images/thnakyou.png" alt="thnak you" className="d-none"/>
                    <h4 className="opacity-75 text-center w-100 d-none d-sm-block">हमारे पर का पालन करें</h4>
                </div>
                <div className="d-flex align-items-center justify-content-evenly ">
                    <div className="w-100 p-2 pt-3 pt-lg-2 pb-2 pb-sm-2 d-flex align-items-center justify-content-evenly">
                        ...
                        </span> <span className="d-none d-md-inline-block">Facebook</span></a>
                        ...
                        </span> <span className="d-none d-md-inline-block">Twitter</span></a>
                        <a className="acol-3 flex-fill" href="https://www.youtube.com/" target="_blank"><span className="img d-flex s-yt">
                            ...
                            </span> <span className="d-none d-md-inline-block">Youtube</span></a>
                        ...
                        </span> <span className="d-none d-md-inline-block">Instagram</span></a>
                        ...
                        </span> <span className="d-none d-md-inline-block">Linkedin</span></a>
                    </div>
                </div>
            </div>
            </div>
