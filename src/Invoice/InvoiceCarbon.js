...
<div className="container-xl shadow p-0 bg-white rounded invoice-wrap overflow-hidden" style={{opacity:0}}>
      ...
      <div className="xd-sm-flex xalign-items-center xjustify-content-between row m-0 p-0">
          ...
          <div className="xalign-self-stretch d-none d-md-block d-md-flex align-items-end justify-content-center col-md-4 ">
              <div className="bg-theme-accent text-theme-secondary text-center p-2 p-md-3 pt-md-4 pb-md-3 px-md-5 title">
                  <span className="fs-3 fw-bold text-uppercase">Invoice</span>
          ...
          <div id="header-right" className="p-1 pe-lg-2 py-lg-2 col-sm-6 col-md-4 col-lg-4 d-md-flex align-items-center justify-content-end">
              <div>
                  <h4 className="text-center text-sm-end pt-1 pt-sm-0">AyataCommerce Pvt. Ltd</h4>                    
      ...
      <div className="row m-0 p-sm-2 p-lg-3 text-center text-sm-start my-row-3 ">
          ...
          <div className="col-sm-4 mb-4 mb-sm-0">
              ...
              <p>
                  ...
                  <b>Phone  :</b> 0987329382<br/>
                  <b>Email :</b> olivia@gmail.com<br/>
                  <b>Customer GST :</b> #######123###
              </p>
          ...
          <div className="align-self-stretch pt-lg-2 pe-lg-3">
              <div className="d-flex flex-column-reverse flex-sm-column w-100 h-100 text-start text-sm-start my-notes">
                  <div className="align-self-stretch flex-grow-1">
                      <p><b>Order Note : </b> At Ayatacommerce, we aim for perfect deliveries every time. In case of a return, please ensure you have the original Brand box, price tag, packing, and invoice, as these are essential for processing your request. Your cooperation is greatly appreciated.                        </p>
                  </div>
  ...
  <section id="sec-sign">
      <div className="d-sm-flex align-items-center justify-content-between px-2 py-lg-2 mt-1 mt-sm-0">
          ...
          <div className="text-center text-sm-end xpy-sm-3 sec-sign-right">
              <h4>AyataCommerce Pvt. Ltd</h4>
              <span id="sign"></span>
              <p><small>Authorized Signatory</small></p>
              <div className="xmt-2 xborder xp-2" style={{marginTop:'15px'}}>
                <p>
                    <h5>Total CO2e: <span style={{ color: '#239f00', fontWeight: 'bold' }}>1.1 kg CO2e</span> </h5>                                       
                </p>
                <p><small>                
                To offset 1.1 kg CO2e, plant <b>1 tree</b> <ForestIcon sx={{ fill: 'green !important' }}/> here :  
                <a style={{color:'green'}} href="https://offset.climateneutralnow.org" target="_blank" rel="noopener noreferrer"> <u>Climate Neutral Now</u></a>
                    </small>
                    </p>
