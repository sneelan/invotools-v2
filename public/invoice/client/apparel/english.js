  ...
  return (
    ...
    <div className="container-xl shadow p-0 bg-white rounded invoice-wrap overflow-hidden" style={{display:'none'}}>
        <header className="px-2 px-lg-2 hover">
            <div className="xd-sm-flex xalign-items-center xjustify-content-between row m-0 p-0">                
                <div id="header-left" className="text-center col-sm-4 col-md-4 col-lg-4 d-flex align-items-center justify-content-center p-0 ps-md-3">
                    <a className="logo m-auto " href="https://invotools.io" target="_blank">invotools.io</a>
                </div>
                <div id="page-title-lg" className="align-items-end justify-content-center col-sm-3 col-md-4 d-none d-sm-flex">
                    <div className="bg-theme-accent text-theme-secondary text-center p-3 pt-4 pb-3 px-3 px-md-3">
                        <h1 className="fw-bold text-uppercase font-secondary">Invoice-Apparel</h1>
                ...
                <div id="header-right" className="p-1 pe-lg-2 py-lg-2 col-sm-5 col-md-4 col-lg-4 d-md-flex align-items-center justify-content-end">
                    <div>
                        <h6 className="text-center text-sm-end pt-1 pt-sm-0 fw-bold">Invotools Pvt Ltd</h6>
                        
                        <p className="text-center text-sm-end pb-1 pb-sm-0">
                            
                            7-11 Barking Rd, East Ham, <br/>
                            London, UK, Zip: nE61PWt<br/>
                            <a className="hover-underline" href="tel:919995473245" target="_blank">+91 9995473245</a>,
                            <a className="hover-underline" href="mailto:info@invotools.io" target="_blank">info@invotools.io</a><br/>
            ...
            <div className="row m-0 p-sm-2 p-lg-2 text-center text-sm-start order-info-row2 ">
                ...
                <div className="col-sm-4 mb-4 mb-sm-0">
                    ...
                    <p>
                        ...
                        <b>Phone  :</b> <a className="hover-underline" href="tel:91987329382" target="_blank">+91 9873 29382</a><br/>
                        <b>Email :</b> <a className="hover-underline" href="mailto:olivia@gmail.com" target="_blank">olivia@gmail.com</a><br/>
                        <b>Customer GST :</b> AXD785125862
                    </p>
                ...
                <div className="col-sm-4 mb-4 mb-sm-0">
                    ...
                    <p>Thomas Wilson<br/>
                        123 Anywhere St<br/>
                        Any City, ST 12345<br/>
                        <b>Phone  :</b> <a className="hover-underline" href="tel:91987329777" target="_blank">+91 9873 29777</a><br/>
                        <b>Email :</b> <a className="hover-underline" href="mailto:thomas@gmail.com" target="_blank">thomas@gmail.com</a><br/></p>
        ...
        <main className="px-2">
                ...
                <table className="w-100">
                    <tbody>
                        <tr className="w-100">
                            ...
                            <th>Tax</th>
                            <th>Discount</th>
                            <th className="highlight carbon">CO2</th>
                        ...
                        <tr>
                            ...
                            <td>10%</td>
                            <td>20%</td>
                            <td className="highlight carbon">0.4 kg</td>
                        ...
                        <tr>
                            ...
                            <td>10%</td>
                            <td>20%</td>
                            <td className="highlight carbon">0.35 kg</td>
            ...
            <div className="mob-products">                
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.invotools.io/" target="_blank"> Fashion Slim Fit Shirts Long Sleeve Navy</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
                            <div><a className="hover-underline" href="https://www.invotools.io/" target="_blank"><img src="/invoice-css/assets/images/pro1.png" alt="Being Human"/></a></div>
                ...
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.invotools.io/" target="_blank"> Fashion Regular Fit Polo Neck Short Slv T-Shirts Rust</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
                            <div><a className="hover-underline" href="https://www.invotools.io/" target="_blank"><img src="/invoice-css/assets/images/pro2.png" alt="Being Human"/></a></div>
                            <div className="flex-grow-1">                            
                                    <div className="mob-pro-right">
                                        <table>
                                            <tbody>
                ...
                <div className="mob-product-row">
                    <div><a className="title h6" href="https://www.invotools.io/" target="_blank">	Fashion Relax Fit Womens Crew Neck T-Shirts</a></div>
                    <div className="d-flex align-items-center justify-content-center gap-3 p-2">                    
                            <div><a className="hover-underline" href="https://www.invotools.io/" target="_blank"><img src="/invoice-css/assets/images/pro3.png" alt="Being Human"/></a></div>
                            <div className="flex-grow-1">                            
                                    <div className="mob-pro-right">
                                        <table>
                                            <tbody>
                    ...
                    <table className="w-100 product-total mt-2 mt-sm-0">
                        <tbody>
                            ...
                            <tr className="bg-theme-accent fw-bold">
                                <td className="h3 fw-bold">Grand Total</td>
                                <td className="h3 fw-bold">₹ 3861.00</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div className="align-self-stretch pt-lg-2 pe-lg-3 colname-2 w-100">                    
                    <div className="d-flex justify-content-evenly flex-column-reverse flex-sm-column w-100 h-100 text-start text-sm-start my-notes">
                        ...
                        <div className="w-100 pb-lg-0 pe-1 pb-sm-0 pt-2 pt-sm-0">
                            <p><strong> Amount in words:</strong> Three Thousand Eight Hundred and Sixty One Rupees</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="py-2 py-lg-2 sec-sign-left">
                    ...
                    <div className="mt-3 mt-sm-2">                        
                        <table className="track-ship w-100">
                            <tbody>
                                <tr>
                                    <td className="text-center text-sm-start px-3 bg-theme-primary1 fw-bold border ">
                ...
                <div className="text-center text-sm-end py-sm-1 sec-sign-right">
                    ...
                    <div className="mt-2 carbon"><p><h6>Total CO2e : 
                        ...
                        <small>To offset 1.1 kg CO2e, plant <b>1 tree</b> 
                            &nbsp;<svg style={{ width: "24px", height: "24px", fill: "green" }} focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ForestIcon"><path d="M16 12 9 2 2 12h1.86L0 18h7v4h4v-4h7l-3.86-6z"></path><path d="M20.14 12H22L15 2l-2.39 3.41L17.92 13h-1.95l3.22 5H24zM13 19h4v3h-4z"></path></svg> 
                            &nbsp;here :<a href="https://offset.climateneutralnow.org" target="_blank" rel="noopener noreferrer" style={{color: "green"}}> <u>Climate Neutral Now</u></a>
                            </small></p></div>
                &nbsp;</div>
            </div>
        </section>
        <footer className="sticky-footer">
            ...
            <div className="align-self-stretch col-sm-4 col-lg-3 bg-theme-secondary footer-left d-flex align-items-center justify-content-center">
                <div className="ps-2 py-3 py-sm-0">
                    <a href="tel:+919995473245">
                        ...
                        <span className="ps-1">+91 9995473245</span>
                    </a>
                   <a href="mailto:info@invotools.io" target="_blank">
                    ...
                    <span className="ps-1"> info@invotools.io</span>
                </a> 
                   <a href="https://invotools.io" target="_blank">
                    ...
                    <span className="ps-1">www.invotools.io</span></a> 
                </div>
            </div>
            <div className="col-sm-8 col-lg-9 align-self-stretch footer-right pb-lg-1">
                ...
                <div className="d-flex align-items-center justify-content-evenly ">
                    <div className="w-100 p-2 pt-3 pt-lg-2 pb-2 pb-sm-2 d-flex align-items-center justify-content-evenly">
                        ...
                        </span> <span className="d-none d-md-inline-block">Whatsapp</span></a>
                        <a className="acol-3 flex-fill" href="https://www.facebook.com/invotools.io/" target="_blank"><span className="img d-flex s-fb">
                        ...
                        <a className="acol-3 flex-fill" href="https://twitter.com/invotools.io" target="_blank"><span className="img d-flex s-x">
                        ...
                        <a className="acol-3 flex-fill" href="https://www.instagram.com/invotools.io9/" target="_blank"><span className="img d-flex s-ig">
                        ...
                        <a className="acol-3 flex-fill" href="https://www.linkedin.com/company/invotools.io" target="_blank"><span className="img d-flex s-li">
